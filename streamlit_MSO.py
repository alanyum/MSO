...
url1 = "https://github.com/alanyum/MSO/blob/master/df_mso_usage_week_subdept_all_hol_ym_cpi_L1333.csv?raw=true"
df_mso_usage_week_subdept_all_hol_ym_cpi_L1333 = pd.read_csv(url1)
url2 = "https://github.com/alanyum/MSO/blob/master/df_mso_usage_week_subdept_all_hol_ym_cpi_L1333_sales_margins_gb_week.csv?raw=true"
df_mso_usage_week_subdept_all_hol_ym_cpi_L1333_sales_margins_gb_week = pd.read_csv(url2)
